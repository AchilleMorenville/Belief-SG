#ifndef BELIEF_SG_GAMES_GOOFSPIEL_H
#define BELIEF_SG_GAMES_GOOFSPIEL_H
...
class Goofspiel : public Game {
public:
    explicit Goofspiel(int num_players);
...
private:
    ...
    std::vector<std::shared_ptr<const PieceType>> card_types_;
};

}  // namespace belief_sg

#endif  //BELIEF_SG_GAMES_GOOFSPIEL_H
