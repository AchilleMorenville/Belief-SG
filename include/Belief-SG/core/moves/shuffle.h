#ifndef BELIEF_SG_CORE_MOVES_SHUFFLE_H
#define BELIEF_SG_CORE_MOVES_SHUFFLE_H
...
class Shuffle : public Move {
public:
    Shuffle() = default;
    explicit Shuffle(const Position& from);
...
#endif  //BELIEF_SG_CORE_MOVES_SHUFFLE_H
